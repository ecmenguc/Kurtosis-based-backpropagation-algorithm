...
clc           
%% letter
load('matlab/features_letter')
load('matlab/output_letter')
shuffle = randperm(length(features_letter));% Data Shuffling
X = features_letter(shuffle,:);
d = output_letter(shuffle,:);
class_num = 26;
alpha = 0.02;
beta = 0.9992;
